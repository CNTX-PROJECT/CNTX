...
- Proposed Artifact-Specific Schema Family and Canonical Artifact Container Boundary (ARCH-010 and ADR-0010); documentation only, allocating nine technology-neutral logical Schema Identities and inactive `1.0.0` targets, a closed root with mandatory `envelope` and `payload`, and the exact Accepted common-envelope reference without creating an executable artifact-specific schema or payload, concrete `$id`, active Schema Version, binding, validator, runtime, implementation, release, or deployment.

...
- Proposed Common Artifact Envelope executable schema definition (ARCH-009 and ADR-0009), one JSON Schema Draft 2020-12 `1.0.0` candidate resource, and synthetic positive/negative validation cases; the candidate defines only the common envelope and does not activate an Accepted Schema Version, define artifact-specific payloads, select an artifact Serialization Binding, or provide a validator, resolver, runtime, product, release, or deployment.

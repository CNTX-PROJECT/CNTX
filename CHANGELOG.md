...
- Proposed Common Artifact Envelope schema identity and initial version policy (ARCH-006 and ADR-0006); documentation only, allocating one technology-neutral logical identity and a `1.0.0` initial accepted version target without creating a concrete Schema Identifier, executable schema, active Schema Version, schema-language choice, serialization, validator, Layer 5 mechanism, runtime, implementation, release, or deployment.

...
- Proposed Project Charter Executable Schema Definition (ARCH-012 and ADR-0012), Project Charter Schema Version `1.0.0` candidate, and synthetic positive/negative validation cases under issue #48; the candidate composes the exact Accepted Common Artifact Envelope with a closed CONTRACT-001 payload and remains inactive pending separate exact-head Owner acceptance and governed integration.

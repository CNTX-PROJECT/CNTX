...
- Proposed Common Artifact Envelope schema language and dialect (ARCH-007 and ADR-0007); documentation only, selecting JSON Schema Draft 2020-12 and its standard vocabulary profile without creating an executable schema, concrete `$id`, composition or packaging model, artifact Serialization Binding, validator, Layer 5 mechanism, runtime, implementation, release, or deployment.

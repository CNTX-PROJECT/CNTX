...
- Proposed Canonical Contract Definition Identity, Initial Version, and Source Binding (ARCH-011 and ADR-0011); documentation only, proposing nine stable Contract Definition Identifiers, independent initial `1.0.0` versions, and exact Accepted-source bindings without changing contract meaning, activating an allocation, or creating an executable artifact-specific schema, binding, resolver, validator, runtime, implementation, release, or deployment.

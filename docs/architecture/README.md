...
CONTRACT-008, the [Decision Record artifact contract](../contracts/decision-record-contract.md), is **Proposed**, subordinate, and governed by ARCH-001, ARCH-002, ARCH-003, and accepted CONTRACT-001 through CONTRACT-007. It does not alter or redefine accepted architecture, Project Charter, Workstream, Task Contract, Context Packet, Execution Result, Evidence Bundle, or Review Record. It becomes binding only after final human acceptance under governance and publication on `main`.

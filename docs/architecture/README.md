...
CONTRACT-006, the [Evidence Bundle artifact contract](../contracts/evidence-bundle-contract.md), is **Proposed** and is governed by ARCH-001, ARCH-002, ARCH-003, and accepted CONTRACT-001 through CONTRACT-005. It does not alter or redefine accepted architecture, Project Charter, Workstream, Task Contract, Context Packet, or Execution Result. Only later final human acceptance and publication on `main` can make it a binding subordinate contract.

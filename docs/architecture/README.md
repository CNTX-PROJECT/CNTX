...
CONTRACT-004, the [Context Packet artifact contract](../contracts/context-packet-contract.md), is **Proposed** and is governed by ARCH-001, ARCH-002, ARCH-003, and accepted CONTRACT-001, CONTRACT-002, and CONTRACT-003. It does not alter or redefine accepted architecture, Project Charter, Workstream, or Task Contract; only if later accepted does it become the binding subordinate Context Packet artifact-specific contract.

...
The [artifact-contract index](docs/contracts/README.md) introduces the first proposed artifact-specific contract, for the Project Charter; it does not introduce an executable schema or runtime.

...
The architecture index now also exposes the **Proposed** [Workstream
...
Proposed [Workstream Schema Version `1.0.0`](schemas/workstream/1.0.0/schema.json),
...
not activate the candidate or grant conformance, approval, authority, release,
deployment, implementation, merge permission, or Task Contract schema
authority.

...
The [artifact-contract index](docs/contracts/README.md) includes the first accepted artifact-specific contract, for the Project Charter, and the second accepted, subordinate artifact-specific contract, for the Workstream. It also records the Task Contract as the third proposed subordinate artifact-specific contract; none introduces an executable schema, permission engine, or runtime.

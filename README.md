...
under issue #96 and attributable EIGENAAR / Final Authority creation comment
`5228385928`. The documentation-only proposal names the work through Accepted
...
does not archive or close the repository, create a supported-version or
...
deploy anything, grant acceptance or merge permission, or authorize a
follow-on phase.

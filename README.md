...
The [artifact-contract index](docs/contracts/README.md) includes the first accepted artifact-specific contract, for the Project Charter, and the next proposed subordinate artifact-specific contract, for the Workstream; neither introduces an executable schema or runtime.
